...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <?php
            $query = " SELECT ruang.idruang AS id, ruang.nama AS nama, ruang.status AS status, karyawan.nama AS knama, karyawan.idkaryawan AS idkaryawan FROM ruang JOIN karyawan ON ruang.idkaryawan = karyawan.idkaryawan ";
                ...
                <div class="col-sm-2">
                    <div class="card" id="home-card">
                        <div id="'.$warna.'">
                            ...
                            <a class="btn-primary btn-sm" href="admin_detail.php?id='.$row->id.'" id="button"> Detail </a>
                            </div>
                        </div>
                    </div>
                </div>';
