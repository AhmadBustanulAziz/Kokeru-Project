        ...
        <div class="page-wrapper">
            ...
            <div id="adminkaryawan_table">
                <table class="table" id="adminkaryawan_tableheading">    
                    ...
                    <?php
                        //Execute the query
                        $query = " SELECT ruang.nama, ruang.status, ruang.idruang, karyawan.idkaryawan, karyawan.nama AS knama FROM ruang JOIN karyawan ON ruang.idkaryawan = karyawan.idkaryawan ";
