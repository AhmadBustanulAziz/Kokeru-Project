        ...
        <div class="page-wrapper">
            ...
            <div id="adminkaryawan_table">
                <table class="table" id="adminkaryawan_tableheading">    
                    ...
                    <?php
                        //Execute the query
                        $query = " SELECT idkaryawan AS ID, nama, email FROM karyawan ORDER BY idkaryawan";
                        ...
                        while ($row = $result->fetch_object()){
                            ...
                            echo '<td><a class="btn-warning btn-sm" href="admin_EditKaryawan.php?id='.$row->ID.'"> Edit</a>&nbsp; &nbsp; <a class="btn btn-danger btn-sm" href="delete_karyawan.php?id='.$row->ID.'">Delete</a> </td>';
                            echo '</tr>';
                            $i++;
                        }
                        echo '<br />';
